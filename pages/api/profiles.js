...
export default async function Profiles(req, res) {
  ...
  async function filter() {
    ...
    for (let i = 0; i < get.length; i += 1) {
      if (!get[i] || !get[i].personaname) { get[i].personaname = '-'; }
      if (!get[i] || !get[i].avatarfull) { get[i].avatarfull = 'https://steamuserimages-a.akamaihd.net/ugc/885384897182110030/F095539864AC9E94AE5236E04C8CA7C2725BCEFF/'; }
      if (!get[i] || !get[i].loccountrycode) { get[i].loccountrycode = ''; }
